    ...
    <ScrollView>
      <Container>
        ...
        {term('1. Termo de Aceitação', '', [
          ...
          'Alertamos que estes Termos e Condições de Uso poderão ser modificados a qualquer momento pela Heavymotors, em virtude de alterações na legislação ou nos Serviços, em decorrência da utilização de novas ferramentas tecnológicas ou, ainda, sempre que, a exclusivo critério da Heavymotors, tais alterações se façam necessárias. A utilização dos Serviços online disponibilizados pela Heavymotors por qualquer usuário implicará em expressa aceitação destes Termos e Condições de Uso.',
        ])}
        {term(
        ...
        {term('3. Acesso a Conteúdo Restrito e Suspensão de Acesso', '', [
          ...
          'A qualquer tempo, sem aviso prévio, a Heavymotors poderá suspender, cancelar ou interromper o acesso aos Serviços, respeitadas as condições da legislação aplicável.',
          'A Heavymotors não se responsabiliza por eventuais danos e/ou problemas decorrentes da demora, interrupção ou bloqueio nas transmissões de dados decorrentes da conexão de internet do usuário.',
        ])}
        {term(
          ...
          [
            ...
            'b) Viole direitos de terceiro ou direitos da Heavymotors ou do Grupo;',
        ...
        {term(
          ...
          [
            ...
            'c) Pela reparação de danos causados a terceiros, à Heavymotors ou ao Grupo, a partir do uso dos Serviços;',
            ...
            'Sem prejuízo das demais isenções de responsabilidade indicadas no presente documento, você se declara ciente de que a Heavymotors não será responsável:',
        ...
        {term('7. Lei aplicável e resolução de conflitos', '', [
          'Toda e qualquer controvérsia oriunda dos termos expostos nestes Termos e Condições de Uso serão solucionados de acordo com a lei brasileira, sendo competente o foro da cidade de Rondonópolis, Estado de Mato Grosso, e Curitiba, Estado do Paraná, com exclusão de qualquer outro por mais privilegiado que seja.',
        ...
        {term('3. Para quais finalidades os dados pessoais são tratados?', '', [
          ...
          'A Heavymotors, na condição de controlador dos dados nos termos da legislação, poderá tratar, coletar, armazenar e compartilhar com as sociedades sob controle direto ou indireto do Grupo, sempre com a estrita observância à Lei, seus dados pessoais e informações cadastrais, financeiras e de operações ativas e passivas e serviços contratados para:',
          '(i) garantir maior segurança e prevenir fraudes;',
          '(ii) assegurar sua adequada identificação, qualificação e autenticação;',
          '(iii) prevenir atos relacionados à lavagem de dinheiro e outros atos ilícitos;',
          '(iv) realizar análises de risco de crédito; (v) aperfeiçoar o atendimento e os produtos e serviços prestados;',
          '(vi) fazer ofertas de produtos e serviços adequados e relevantes aos seus interesses e necessidades de acordo com o seu perfil; e ',
          '(vii) outras hipóteses baseadas em finalidades legítimas, como apoio e promoção de atividades da Heavymotors e do Grupo ou para a prestação de serviços que beneficiem os clientes.',
          'A Heavymotors compartilha infraestrutura, sistemas e tecnologia com outras empresas do Grupo para fornecer uma experiência inovadora, relevante, consistente e segura em todos os produtos e serviços das empresas do Grupo.',
          'Ainda, processamos informações sobre você nas empresas do Grupo com este objetivo, conforme permitido pela lei aplicável e de acordo com esta política.',
          'Ressaltamos que novos serviços online, disponibilizados pela Heavymotors, estarão automaticamente sujeitos à Política de Privacidade vigente à época de sua utilização. Queremos oferecer a melhor experiência durante a sua navegação em nossos sites e também na internet.',
        ])}
        ...
        {term(
          ...
          [
            ...
            '• › Veículo(s) ofertado(s) no Portal;',
            '• › Veículo(s) pesquisado(s) no Portal;',
            '• › Veículo(s) de propriedade do internauta;',
            '• › Aquisição e forma de pagamento do produto ou serviço solicitado no Portal;',
            '• › Preferências do cliente;',
            '• › Opiniões do internauta;',
            '• › Acesso do internauta (exemplo: data e horário derealização do acesso);',
        ...
        {term('5. Uso de cookies', '', [
          ...
          'Você pode desativar os cookies não-essenciais para a utilização dos Serviços através das preferências do seu navegador. Sem eles, sua navegação pode se tornar limitada e algumas funcionalidades dos sites podem ficar comprometidas. Veja as definições sobre cookies em cada um dos navegadores.',
        ...
        {term('10. Como tratamos as suas informações de forma segura?', '', [
          ...
          'A Webmotors poderá revelar as informações pessoais que tenha recebido nas seguintes hipóteses:',
          ...
          'Além dos casos acima citados, havendo a necessidade ou interesse em repassar a terceiros, exceto aqueles já mencionados acima, dados de identificação individual dos clientes/usuários/internautas, a Heavymotors lhes solicitará autorização prévia.',
          'Informações que não sejam de identificação individual (como demográficas, por exemplo), poderão ser repassadas a anunciantes, fornecedores, patrocinadores e parceiros, com o objetivo de melhorar a qualidade dos produtos e serviços oferecidos pela Heavymotors.',
          ...
          'A Heavymotors assegura que as informações (textos, imagens, sons e/ou aplicativos) contidas nos seus sites estão de acordo com a legislação e normativos que regulam os direitos autorais, marcas e patentes, não sendo permitidas modificações, cópias, reproduções ou quaisquer outras formas de utilização para fins comerciais sem o consentimento prévio e expresso da Heavymotors.',
          'A Heavymotors não se responsabiliza por eventuais danos e/ou problemas decorrentes da demora, interrupção ou bloqueio nas transmissões de dados ocorridos na Internet.',
        ])}
        ...
        {term('Notícias e publicidade', '', [
          ...
          'As mensagens enviadas em formato HTML podem conter códigos que permitem personalizar mensagens de acordo com as preferências individuais do cliente/usuário registrado da Heavymotors e elaborar relatórios sobre a visualização das mensagens, sobre o número de vezes em que o e-mail foi aberto e o número de cliques feitos na mensagem.',
          'Estas informações serão utilizadas de forma genérica e agregada para elaborar relatórios sobre o envio de mensagens. Tais relatórios poderão ser repassados aos anunciantes, como indicadores estatísticos da efetividade das campanhas, sem revelar informações pessoais dos clientes/usuários.',
        ...
        {term('Proteção dos dados transacionais', '', [
          ...
          'Em alguns pontos do Portal Heavymotors são coletadas informações de identificação individual e/ou cadastral (como nome completo ou razão social, endereço, telefones, dados da(s) Máquina(s) Agrícola(s), Implemento(s), Máquina(s) Linha Amarela (Construção) e Caminhões etc.) necessárias à navegação ou utilização dos serviços disponíveis.',
          'Como medida de proteção, as informações de identificação individual e/ou cadastral coletadas pelo Portal Heavymotors passam por processo de criptografia em todas as páginas de coleta de dados (como o anúncio de um automóvel ou adesão a um plano) e nas áreas seguras do site onde um usuário e senha são solicitados. Tal processo é certificado pela (Amazon Certificadora Digital), certificadora de servidores web, garantindo comunicações e transações seguras.',
        ...
        {term('17. Dispositivos Móveis', '', [
          ...
          'a) Localização: Necessário para validação da cidade em que o usuário se encontra com o objetivo de facilitar a busca da(s) Máquina(s) Agrícola(s), Implemento(s) Agrícola(s), Máquina(s) Linha Amarela (Construção) e Caminhões na Heavymotors.',
          'b) Telefone (fazer e gerenciar chamadas telefônicas) É necessário para a realização de ligação telefônica nas funções de “click to call”.',
